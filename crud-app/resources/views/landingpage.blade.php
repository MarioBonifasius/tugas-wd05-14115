...
<head>
    ...
    <title>Aplikasi Temu Janji</title>
    <style>
        /* Reset CSS */
        * {
            margin: 0;
...
<body>
    ...
    <header id="header">
        <div class="container nav-container">
            <a href="#" class="logo">Aplikasi Temu Janji<span style="color:var(--accent-color)">.</span></a>
        ...
        <div class="container">
            <div class="footer-container">
                <div class="footer-column">
                    <h3>Aplikasi Temu Janji<span style="color:var(--accent-color)">.</span></h3>
                    <p>Aplikasi Temu Janji is a modern health clinic dedicated to providing high-quality medical care
                        for individuals and families. We offer a wide range of healthcare services. With a team of
                        experienced doctors and
                        friendly staff, Medical Clinic ensures every patient receives professional treatment in a
            ...
            <div class="copyright">
                <p>&copy; 2025 Aplikasi Temu Janji. All rights reserved.</p>
            </div>
        </div>
    </footer>
